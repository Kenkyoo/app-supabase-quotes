...
export default function Hero({ quote, kind }: { quote: string; kind: string }) {
  return (
    <div className="relative min-h-screen flex items-center justify-center px-6 overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-3xl">
        ...
        <Badge variant="destructive" className="mt-10">
          <p className="md:text-lg text-foreground/80">{kind}</p>
        </Badge>
